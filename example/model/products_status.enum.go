...
func (v *ProductsStatus) Scan(i interface{}) (err error) {
	s, ok := i.(string)
	if !ok {
		return fmt.Errorf("value (%#v) is not of the expected type string", i)
	}
	switch {
	case reflect.DeepEqual(s, "out_of_stock"):
		*v = OutOfStock
	case reflect.DeepEqual(s, "in_stock"):
		*v = InStock
	case reflect.DeepEqual(s, "running_low"):
		*v = RunningLow
	default:
...
Generated by dbml-go
    version: v1.0.0
    timestamp: 2023-02-07 11:02:21.793738718 +0000 UTC m=+0.006037293
*/
